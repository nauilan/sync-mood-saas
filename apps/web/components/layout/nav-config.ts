...
export const MASTER_NAV: NavSection[] = [
  ...
  { title: 'M1 Cadastros', items: [
    ...
    { label: 'Organizacao Gestora', href: '/master/editora', iconName: 'Settings', hidden: true },
  ]},
  { title: 'M2 Contratos', items: [
    ...
    { label: 'Alertas Exclusividade', href: '/master/contratos/alertas', iconName: 'ShieldAlert', hidden: true },
  ]},
  ...
  { title: 'M4 Autorizacoes', items: [
    ...
    { label: 'Nova Autorizacao', href: '/master/autorizacoes/nova', iconName: 'FilePlus', hidden: true },
  ]},
  ...
  { title: 'BackOffice — Informacao', items: [
    { label: 'Dashboard',                href: '/master/backoffice',                      iconName: 'Database',      hidden: true },
    { label: 'Catalogo BackOffice',      href: '/master/backoffice/catalogo',             iconName: 'BookOpen',      hidden: true },
    { label: 'Importacao de Arquivos',   href: '/master/backoffice/importacao',           iconName: 'FileInput',     hidden: true },
    { label: 'Importacao CWR',           href: '/master/cwr',                             iconName: 'FileCode2'      },
    { label: 'Exportacoes CWR',          href: '/master/backoffice/exportacoes',          iconName: 'Upload',        hidden: true },
    { label: 'Analise de Lancamentos',   href: '/master/backoffice/matching',             iconName: 'Shuffle',       hidden: true },
    { label: 'ONI — Obras Nao Id.',      href: '/master/backoffice/match-lista-oni',      iconName: 'Target',        hidden: true },
    { label: 'Relatorios BackOffice',    href: '/master/backoffice/relatorios',           iconName: 'BarChart3',     hidden: true },
    { label: 'Auditoria Analitico',      href: '/master/auditoria-analitico',             iconName: 'Scale'          },
    { label: 'Logs de Processamento',    href: '/master/backoffice/logs',                 iconName: 'ScrollText',    hidden: true },
    { label: 'Pendencias Juridicas',     href: '/master/backoffice/pendencias-juridicas', iconName: 'AlertTriangle', hidden: true },
    { label: 'Configuracoes BackOffice', href: '/master/backoffice/configuracoes',        iconName: 'Settings',      hidden: true },
  ]},
  ...
  { title: 'Financeiro — Dinheiro', items: [
    ...
    { label: 'Periodos de Pagamento',href: '/master/financeiro/periodos',           iconName: 'Calendar',        hidden: true },
    { label: 'Recebimentos',         href: '/master/recebimentos',                  iconName: 'DollarSign'      },
    { label: 'Conferencia',          href: '/master/recebimentos/divergencias',     iconName: 'CheckCircle2',    hidden: true },
  ...
  { title: 'M7 Conciliacao', items: [
    { label: 'Conciliacoes',       href: '/master/conciliacao',              iconName: 'Activity',      hidden: true },
    { label: 'Divergencias Conc.', href: '/master/conciliacao/divergencias', iconName: 'AlertTriangle', hidden: true },
  ]},
  { title: 'M12-13 Relatorios & BI', items: [
    ...
    { label: 'Obras Gravadas',      href: '/master/relatorios/obras-gravadas',   iconName: 'Mic2',        hidden: true },
    { label: 'Titulares',           href: '/master/relatorios/titulares',        iconName: 'Users'                     },
    { label: 'Contratos',           href: '/master/relatorios/contratos',        iconName: 'FileText',    hidden: true },
    { label: 'Autorizacoes',        href: '/master/relatorios/autorizacoes',     iconName: 'Shield',      hidden: true },
    { label: 'Recebimentos',        href: '/master/relatorios/recebimentos',     iconName: 'Download',    hidden: true },
    { label: 'CC Obras',            href: '/master/relatorios/cc-obras',         iconName: 'Music',       hidden: true },
    { label: 'CC Titulares',        href: '/master/relatorios/cc-titulares',     iconName: 'Users',       hidden: true },
    { label: 'Financeiros',         href: '/master/relatorios/financeiros',      iconName: 'DollarSign',  hidden: true },
    { label: 'Royalties Futuros',   href: '/master/relatorios/royalties-futuros',iconName: 'TrendingUp',  hidden: true },
    { label: 'BI Estrategico',      href: '/master/relatorios/bi-estrategico',   iconName: 'Sparkles',    hidden: true },
    { label: 'Auditoria Relatorios',href: '/master/relatorios/auditoria',        iconName: 'ShieldAlert', hidden: true },
  ]},
  ...
  { title: 'Administracao', items: [
    ...
    { label: 'Perfis',             href: '/master/configuracoes/perfis',              iconName: 'Shield',      hidden: true },
    { label: 'Permissoes',         href: '/master/configuracoes/permissoes',          iconName: 'ShieldAlert', hidden: true },
    { label: 'Modelos Autorizacao',href: '/master/configuracoes/modelos-autorizacao', iconName: 'BookOpen',    hidden: true },
    { label: 'Parametros',         href: '/master/configuracoes/parametros',          iconName: 'Settings',    hidden: true },
