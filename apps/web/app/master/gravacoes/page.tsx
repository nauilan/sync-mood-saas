import { Mic2, Construction } from 'lucide-react'

export const metadata = { title: 'Gravacoes ISRC | Sync Mood' }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
      <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-5 shadow-[0_0_32px_rgba(139,92,246,0.25)]"
        ...
        <Mic2 className="w-7 h-7 text-violet-400" strokeWidth={1.5} />
      </div>
      <h1 className="text-xl font-bold text-white mb-2">Gravacoes ISRC</h1>
      <p className="text-sm text-white/40 max-w-sm">
        Cadastro de gravações com código ISRC. Esta funcionalidade está em desenvolvimento e estará disponível em breve.
      </p>
