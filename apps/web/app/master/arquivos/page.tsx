...
export const metadata = { title: 'Arquivos / Assinaturas | Sync Mood' }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
      <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-5 shadow-[0_0_32px_rgba(139,92,246,0.25)]"
        ...
        <Archive className="w-7 h-7 text-violet-400" strokeWidth={1.5} />
      </div>
      <h1 className="text-xl font-bold text-white mb-2">Arquivos / Assinaturas</h1>
      <p className="text-sm text-white/40 max-w-sm">
        Gestão de arquivos contratuais e assinaturas digitais. Esta funcionalidade está em desenvolvimento e estará disponível em breve.
      </p>
